...
export const SeeMoreBtn = styled.a`
  ${tw`absolute items-center hidden -rotate-90 cursor-pointer laptop:flex 3xl:left-4 3xl:bottom-60 laptop:bottom-48 laptop:left-3 opacity-60 hover:opacity-100`}
`;
...
export const SeeMoreTitle = styled.span`
  ${tw`text-xs font-semibold tracking-widest text-white uppercase 3xl:text-sm`}
`;
...
export const SlideNumberContainer = styled.div`
  ${tw`absolute right-[52px] 3xl:bottom-44 laptop:bottom-36 laptop:flex items-end 3xl:text-lg font-semibold text-white laptop:text-base hidden`}
`;
...
export const FeaturedLocationCard = styled.div`
  ${tw`relative flex items-center 3xl:h-[108px] mx-3 text-white capitalize rounded-md  3xl:w-[416px] laptop:h-[86px] laptop:w-[332px]`}
`;
export const LocationIconContainer = styled.div`
  ${tw`3xl:mx-9 laptop:mx-7`}
`;
export const LocationTitleWrapper = styled.div`
  ${tw`flex flex-col`}
`;
export const LocationTitle = styled.span`
  ${tw`font-bold 3xl:text-xl laptop:text-base`}
`;
export const LocationSeeMore = styled.a`
  ${tw`font-normal cursor-pointer 3xl:text-base opacity-40 hover:opacity-100 laptop:text-xs`}
`;
