...
const CheckboxContainer = styled.div`
  ...
  ${tw`border-solid border-[1px] border-primary rounded-3xl w-fit px-6 py-3 mr-4 mb-2 hover:bg-bg-blue flex`}
`;
...
const CheckboxLabel = styled.label`
  ...
  ${tw`text-primary font-bold text-xs cursor-pointer flex`}
`;
