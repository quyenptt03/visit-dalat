...
export const Container = styled.div`
  ...
  ${tw`block w-full laptop:mb-16 h-full px-5 laptop:pl-8 2xl:px-3 2xl:pr-5 3xl:px-5`}
`;
export const ImageContainer = styled.div`
  ${tw`w-full h-full overflow-hidden rounded-lg cursor-pointer 3xl:mb-5 laptop:mb-4 relative`}
`;
export const Image = styled.img`
  ${tw`object-cover w-full h-full transition-all duration-300 ease-linear rounded-lg hover:transform hover:scale-105 block`}
`;
