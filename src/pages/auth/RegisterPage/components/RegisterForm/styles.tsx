...
const Container = styled.div`
  ${tw`text-black tablet:mt-14 mt-10 pt-4 tablet:pb-6 mx-4 tablet:px-9 w-full tablet:w-fit pb-3 px-4 border-[1px] border-[#878787] shadow-md rounded-lg mb-10`}
`;
